...
Brain.prototype.getInputs = function() {
	...
	if(nearObstacle != null) {
		var speed = this.host.game.p5.map(this.host.game.speed, 0, 15, 0, 1); //speed (0 to 1)
		var distance = this.host.game.p5.map(nearObstacle.x, 0, 500, 0, 1); //distance form next obtstalce (0 to 1)
		var width = this.host.game.p5.map(nearObstacle.width, 0, 73, 0, 1);
